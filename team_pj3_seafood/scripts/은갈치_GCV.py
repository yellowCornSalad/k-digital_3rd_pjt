...
file1 = '/Users/junho/Documents/k-digital_3rd_pjt/k-digital_3rd_pjt/team_pj3_seafood/scripts/seafood_2022-06-30.csv'
file2 = '/Users/junho/Documents/k-digital_3rd_pjt/k-digital_3rd_pjt/team_pj3_seafood/scripts/갈치2022.csv'
...
df1.columns = ['date', 'species', 'origin',
               'standard', 'unit', 'amount', 'weight', 'avg_price']
df2.columns = ['date', 'species', 'origin',
               'standard', 'unit', 'amount', 'weight', 'avg_price']
...
standard_mask = (eg_pdf.standard == '10미') | (eg_pdf.standard == '20미') | (
    eg_pdf.standard == '25미') | (eg_pdf.standard == '5미')
...
rf_grid_cv = GridSearchCV(rf, param_grid=rf_parameters,
...
xgb_grid_cv = GridSearchCV(
    xgb, param_grid=xg_parameters, cv=6, n_jobs=-1, scoring='r2')
...
lgb = LGBMRegressor()
lgb_grid_cv = GridSearchCV(
    lgb, param_grid=lgb_parameters, cv=6, n_jobs=-1, scoring='r2')
